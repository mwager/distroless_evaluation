...
# TODO: https://www.heise.de/hintergrund/VMs-mit-Vagrant-erstellen-2066800.html?seite=3
...
Vagrant.configure("2") do |config|
  ...
  ## needed for nfs shared folders: https://developer.hashicorp.com/vagrant/docs/networking/private_network
